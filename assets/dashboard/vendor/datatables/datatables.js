 ...
 *   https://datatables.net/download/#bs5/dt-1.13.4/fh-3.3.2/r-2.4.1/sc-2.1.1/sb-1.4.2
 *
 * Included libraries:
 *   DataTables 1.13.4, FixedHeader 3.3.2, Responsive 2.4.1, Scroller 2.1.1, SearchBuilder 1.4.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.13.4/fh-3.3.2/r-2.4.1/sc-2.1.1/sb-1.4.2",
