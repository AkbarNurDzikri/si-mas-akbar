<?php
require_once dirname(__DIR__, 4) . '/assets/dashboard/vendor/mpdf/autoload.php';
...
$html = '<!DOCTYPE html>
          ...
          <head>
            ...
            <title>Laporan Distribusi Infaq</title>
          </head>
          <body>
            ...
            <h4 style="text-align: center;">Laporan Distribusi Infaq</h4>
