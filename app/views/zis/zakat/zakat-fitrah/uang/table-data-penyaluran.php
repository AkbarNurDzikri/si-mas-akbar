  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="dateRangeReportLabel">Laporan Distribusi Zakat Fitrah (Uang)</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form action="<?= BASEURL . '/zakat_fitrah/laporan_uang_keluar' ?>" method="POST">
...
<script>
  ...
  $(function() {
    $('#myTable').dataTable({
      ...
      'serverSide': true,
      'ajax': {
        'url': '<?= BASEURL . "/zakat_fitrah/uangKeluarAjax" ?>',
        'dataType': 'json',
        'type': 'POST'
      },
      'columns': [
