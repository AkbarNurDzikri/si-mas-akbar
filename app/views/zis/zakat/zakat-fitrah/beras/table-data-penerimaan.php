    ...
    <div class="card">
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item text-primary" href="<?= BASEURL . '/zakat_fitrah/beras' ?>"><i class="bi bi-download"></i> Penerimaan</a></li>
      ...
      <div class="card-body table-responsive mt-3">
        <a href="<?= BASEURL . '/zakat_fitrah/catat_beras_masuk' ?>" class="btn btn-success btn-sm mb-3"><i class="bi bi-plus-circle"></i> Zakat Masuk</a>
        <table class="table table-striped display caption-top" id="myTable">
          ...
          <tbody>
            ...
            <?php foreach($data['zakat_fitrah_beras_masuk'] as $fitrah) : ?>
              ...
              <tr>
                ...
                <td class="text-center align-middle">
                  <a href="<?= BASEURL . "/zakat_fitrah/beras_masuk_edit/" . $fitrah['id'] ?>" class="btn btn-sm btn-success mb-1"><i class="bi bi-pencil-square"></i></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= BASEURL . '/zakat_fitrah/laporan_beras_masuk' ?>" method="POST">
...
<script>
  ...
  function confirmDelete(id, name) {
    if(confirm(`Yakin hapus data ${name} ?`)) {
      $.ajax({
        url: '<?= BASEURL . "/zakat_fitrah/beras_masuk_delete/" ?>' + id,
        type: 'POST',
        data: 'id=' + id,
