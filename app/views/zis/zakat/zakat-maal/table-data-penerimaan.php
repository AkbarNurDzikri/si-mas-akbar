          ...
          <tbody>
            ...
            <?php foreach($data['zakat_masuk'] as $maal) : ?>
              ...
              <tr>
                ...
                <td class="text-end align-middle">Rp. <?= number_format($maal['qty_in'], 2,',', '.') ?></td>
                <td class="text-center align-middle"><?= $maal['remarks'] ?></td>
                <td class="text-center align-middle"><?= $maal['username'] ?></td>
                <td class="text-center align-middle">
                  <a href="<?= BASEURL . "/zakat_maal/penerimaan_edit/" . $maal['id'] ?>" class="btn btn-sm btn-success mb-1"><i class="bi bi-pencil-square"></i></a>
